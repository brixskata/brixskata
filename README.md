...
- Created system documentation including ERD, Process Flow Diagrams (PFD), and Data Flow Diagrams (DFD).
- Developed dynamic reporting modules, history logs, and role-based access features.
...
- Automated attendance recording and reporting.
